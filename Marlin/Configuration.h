...
#define DEFAULT_MAX_FEEDRATE          {180, 180, 2.6, 25}    // (mm/sec) feedrate for Makerfarm
#define DEFAULT_MAX_ACCELERATION      {3000, 3000, 100, 10000}    // X, Y, Z, E maximum start speed for accelerated moves for Makerfarm
